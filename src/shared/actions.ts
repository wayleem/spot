...
export type add_playing_player = { type: "add_playing_player", player: Model, team: Team }

export type remove_playing_player = { type: "remove_playing_player", player: Model, team: Team }

export type decrement_game_time = { type: "decrement_game_time" }

export type set_game_time = { type: "set_game_time", timer: number }

export type set_store = { type: "set_store", GameState: GameState }

export type actions = set_game_stage | add_player_data | edit_player_data | remove_player_data | add_playing_player | remove_playing_player | decrement_game_time | set_game_time | set_store
